                        ...
                        <div class="photo-list main-photo">
                            ...
                            <form action="index.html" method="POST">
                                <div class="container px-4 px-lg-5 mt-5">
                                    ...
                                    <h3 class="display-4 color-on-primary text-center">Pedidos Realizados</h3>     
                                    <br>   
                                    <div class="">
                                        <table class="table">
                                            <thead>
                                              <tr>
                                                <th class="small-col" scope="col">Núm</th>
                                            ...
                                            <tbody>
                                              <tr>
                                                ...
                                                <td>
                                                    <p>Sabores: Chocolate | Queso</p>                                               
                                                    <p>Adornos: Velas | Sarzamora</p> 
                                                </td>
                                              </tr>
                                              <tr>
                                                <th scope="row">2</th>
                                    ...
                                    <h3 class="display-4 color-on-primary text-center">Inventario</h3>     
                                    <br>   
                                    <div class="">
                                        <table class="table">
                                            <thead>
                                            ...
                                            <tbody>
                                              <tr>     
                                                <th scope="row">1</th>                                           
                                                <td>Queso: 12 pzas.</td>
                                                <td>Sarzamora: 12 kg.</td>                                                
                                              </tr>
                                              <tr>   
                                                <th scope="row">2</th>                                            
                                                <td>Chocolate: 22 pzas.</td>
                                                <td>Fresas: 5 kg.</td>                                                
                                              </tr>
                                              <tr>      
                                                <th scope="row">3</th>                                         
                                                <td>Vainilla: 30 pzas.</td>
                                                <td>Durazno: 25 kg.</td>
                                              </tr>
                                            </tbody>
                                          </table>   
