                    ...
                    <div class="header-nav">
                        ...
                        <div class="header-nav__container">
                            <div class="header-nav__menu">
                                <nav class="nav">
                                    <ul class="nav__list">
                                        <li class="nav__item"><a href="#categorias" class="nav__link">Categorías</a>
                                        </li>
                                        <li class="nav__item"><a href="#tutorial" class="nav__link">Tutorial</a></li>

                                        <li class="nav__item"><a href="#pasteles" class="nav__link">Pasteles</a></li>
                                        <li class="nav__item"><a href="#reviews" class="nav__link">Contacto</a></li>
                                        <li class="nav__item"><a href="admin.html" class="nav__link">Admin</a></li>
                                    </ul><!-- //nav__list -->
                                </nav><!-- //nav -->
                            </div>
