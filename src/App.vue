<template>
            ...
            <div class="header-nav__menu">
              <nav class="nav">
                <ul class="nav__list">
                  ...
                  <li class="nav__item">
                    <a href="#tutorial" class="nav__link">Tutorial</a>
                  </li>
  ...
  <main id="main" class="main">
                    ...
                    <div class="row">
                                ...
                                <div class="photo-item main-photo-item main-photo-item-1">
                                    <div class="photo-img">
                                        <div class="photo-img__block">
                                            <img src="https://i.postimg.cc/Px2WXwbY/vainilla-fresa-durazno.jpg"
                                                alt="main-page-1">
                                        </div>
                                    </div>
                        ...
                        <div class="col col_5 col_desktop-12 order-desktop-1">
                            <div class="main-container">
                                <h1 class="h1 main-title">Arma a tu estilo con<br><span
                        ...
                        <div class="dignity-item col col_4 col_mob-12">
                            <div class="dignity-block">
                                ...
                                <div class="dignity-description wysiwyg">
                                    <p>Mollis sit odio sit aliquet facilisi. Feugiat nullam bibendum suspendisse
                                        consequat morbi et scelerisque</p>
                                </div>
                            </div>
                        </div>
                        <div class="dignity-item col col_4 col_mob-12">
                            <div class="dignity-block">
                                ...
                                <div class="dignity-description wysiwyg">
                                    <p>Sit odio sit aliquet facilisi. Feugiat nullam bibendum suspendisse consequat
                                        morbi et scelerisque</p>
                                </div>
                            </div>
                        </div>
                        <div class="dignity-item col col_4 col_mob-12">
            ...
            <section id="tutorial" class="section">
                <div class="container">
                    <div class="row">
                        <div class="col col_6 col_desktop-12">
                            <div class="photo-list emotional-photo">
                                <div class="photo-item emotional-photo__item emotional-photo__item-1">
                                    <div class="photo-img">
                                        <div class="photo-img__block">
                                            <img src="https://i.postimg.cc/5tJL83n8/queso.jpg" alt="main-page-3">
                                        </div>
                                    </div>
                                    <div class="photo-info wysiwyg"></div>
                                </div>
                                <div class="photo-item emotional-photo__item emotional-photo__item-2">
                                    <div class="photo-img">
                                        <div class="photo-img__block">
                                            <img src="https://i.postimg.cc/VkfZMv8N/velas.jpg" alt="main-page-4">
                                        </div>
                                    </div>
                                    <div class="photo-info wysiwyg"></div>
                                ...
                                <div class="photo-item emotional-photo__item emotional-photo__item-3">
                                    <div class="photo-img">
                                        <div class="photo-img__block">
                                            <img src="https://i.postimg.cc/MZ37g1p8/queso-sarzamora.jpg"
                                                alt="main-page-5">
                                        </div>
                                    </div>
                                    <div class="photo-info wysiwyg"></div>
                        ...
                        <div class="col col_6 col_desktop-12">
                            <h2 class="h2 emotional-title">Ponte creativo con tu pedido en tres sencillos pasos</h2>
                                    ...
                                    <div class="emotional-block">
                                        ...
                                        <div class="emotional-info">
                                            ...
                                            <div class="emotional-description wysiwyg">
                                                <p>Después de dar clic en el botón "Armar ahora" da clic en el sabor que
                                                    quieras agregar. Puedes combinar tantos como desees </p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="emotional-item">
                                    <div class="emotional-block">
                                        ...
                                        <div class="emotional-info">
                                            ...
                                            <div class="emotional-description wysiwyg">
                                                <p>Baja un poco el scroll y ahora agrega tandos adornos y decoraciones
                                                    com gustes (cubierta como accesorios)</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="emotional-item">
                                    <div class="emotional-block">
                                        ...
                                        <div class="emotional-info">
                                            ...
                                            <div class="emotional-description wysiwyg">
                                                <p>Se te pediran tus datos de contacto para hacerte tu pedido. Clic en
                                                    "ordenar" y ¡listo! </p>
                                            </div>
                                        </div>
                                    </div>
            ...
            <section id="pasteles" class="section section-main__post">
                <div class="container">
                    <div class="row">
                        <div class="col col_3 col_desktop-12"></div>
                        <div class="col col_6 col_desktop-12">
                            <div class="post-description text-center text-mob-left">
                                <h2 class="h2 title">Elige algunos <span class="round-border round-border-2">estilos
                                        sugeridos</span></h2>
                            ...
                            <div class="swiper-wrapper post-slider__wrapper">
                                <div class="swiper-slide slider-item post-slider__item">
                                    <div class="post-slider__image">
                                        <img src="https://i.postimg.cc/MZ37g1p8/queso-sarzamora.jpg" alt="main-page-7">
                                    </div>
                                    <div class="post-slider__info">
                                        <h3 class="h3 title">Queso con zarsamora</h3>
                                        <div class="wysiwyg">
                                            <p>Con deliciosa mermelada de zarzamora. </p>
                                        </div>
                                        <div class="display-flex justify-between align-center flex-wrap">
                                            ...
                                            <button type="button" class="btn btn_secondary">Ordenar</button>
                                        </div>
                                    </div>
                                ...
                                <div class="swiper-slide slider-item post-slider__item">
                                    <div class="post-slider__image">
                                        <img src="https://i.postimg.cc/kgKWVZFn/chocolate-fresas.jpg" alt="main-page-8">
                                    </div>
                                    <div class="post-slider__info">
                                        <h3 class="h3 title">Chocolate y fresas</h3>
                                        <div class="wysiwyg">
                                            <p>Con crema batida de chocolate. </p>
                                        </div>
                                        <div class="display-flex justify-between align-center flex-wrap">
                                            <div class="prise">
                                                $24
                                ...
                                <div class="swiper-slide slider-item post-slider__item">
                                    <div class="post-slider__image">
                                        <img src="https://i.postimg.cc/d338LVnX/cumplea-os.jpg" alt="main-page-9">
                                    </div>
                                    <div class="post-slider__info">
                                        <h3 class="h3 title">Feliz Cumple</h3>
                                        <div class="wysiwyg">
                                            <p>Con crema batida, chispas y velas. </p>
                                        </div>
                                        <div class="display-flex justify-between align-center flex-wrap">
                                            <div class="prise">
                                                $24
                                ...
                                <div class="swiper-slide slider-item post-slider__item">
                                    <div class="post-slider__image">
                                        <img src="https://i.postimg.cc/fyPYXQrb/vainilla-durazno.jpg"
                                            alt="main-page-10">
                                    </div>
                                    <div class="post-slider__info">
                                        <h3 class="h3 title">Vainilla y durazno</h3>
                                        <div class="wysiwyg">
                                            <p>Con crema batida. </p>
                                        </div>
                                        <div class="display-flex justify-between align-center flex-wrap">
                                            <div class="prise">
                                                $24
